...
void GameView::setSeatData(int RowIndex, int ColIndex, int data)
{
...
int GameView::checkSeatData(int RowIndex, int ColIndex)
{
    return seatsData[RowIndex][ColIndex];
}
void GameView:: writeSeatsData()
{
